...
//		postMethod.setHeader("Origin", "http://comment5.news.sina.com.cn");
	...
	public String getHtml(String url) throws ClientProtocolException, IOException{
		...
		HttpGet getMethod = newHttpGetNews(url);
	...
	public String getNewsId(String url,String beg,String end) throws ClientProtocolException, IOException{
		return get(url,beg,end);
	}
...
//		client.getParams().setAuthenticationPreemptive(true);
	...
	protected HttpGet newHttpGetNews(String url){
...
//		getMethod.setHeader("Host", "comment5.news.sina.com.cn");
//		getMethod.setHeader("Origin", "http://comment5.news.sina.com.cn");
		return getMethod;
	}
